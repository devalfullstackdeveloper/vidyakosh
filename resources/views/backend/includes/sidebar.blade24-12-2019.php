        ...
        <ul class="nav">
                 ...
                 <li class="nav-item ">
                    <a class="nav-link {{ $request->segment(2) == 'ministry' ? 'active' : '' }}"
                       href="{{ route('admin.training_types.index') }}">
                        <i class="nav-icon icon-directions"></i>
                        <span class="title">@lang('menus.backend.sidebar.trainingtypes.title')</span>
                    </a>
                </li>
            ...
            @can('category_access')
                <li class="nav-item ">
				 ...
				 <!-- <li class="nav-item ">
                    <a class="nav-link {{ $request->segment(2) == 'subcategories' ? 'active' : '' }}"
                       href="{{ route('admin.subcategories.index') }}">
                        <i class="nav-icon icon-folder-alt"></i>
                        <span class="title">@lang('menus.backend.sidebar.subcategories.title')</span>
                    </a>
                </li> -->
            @endcan
            ...
            @if ($logged_in_user->isAdmin())
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ active_class(Active::checkUriPattern('admin/auth/role*')) }}"
                               href="{{ route('admin.faculty.index') }}">
                                @lang('labels.backend.access.roles.faculty')
                            </a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="nav-item nav-dropdown {{ active_class(Active::checkUriPattern('admin/*'), 'open') }}">
                    ...
                    <ul class="nav-dropdown-items">
						...
						<li class="nav-item">
                            <a class="nav-link {{ active_class(Active::checkUriPattern('admin/log-viewer/logs*')) }}"
                               href="{{ route('admin.default-settings') }}">
