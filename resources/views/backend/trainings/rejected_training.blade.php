...
@section('content')
    <div class="card">
        <div class="card-header">
            <h3 class="page-title d-inline">@lang('labels.backend.rejects.title')</h3>
                    ...
                    <div class="table-responsive">
                        <table id="myTable"
                            ...
                            <tr>
                                ...
                                <th>@lang('labels.backend.rejects.fields.title')</th>
                                <th>Venue</th>
                                <th>To be Organised by</th>
                                <th>@lang('labels.backend.rejects.fields.request')</th>
                                <th>@lang('labels.backend.rejects.fields.requestdate')</th>
                                <th>@lang('labels.backend.rejects.fields.name')</th>
                                <th>@lang('labels.backend.rejects.fields.date')</th>
                                <th>Nomination From</th>
                                <th>@lang('labels.backend.rejects.fields.action')</th> 
