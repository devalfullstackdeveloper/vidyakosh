                    ...
                    success:function(data) {
						...
						$.each(data, function(a,b) {
							$(table).append($('<tr>')
											...
											.append($("<td><input type='hidden' id='first_name"+num+"' name='user_id[]' value="+b.user_id+"></td>").append(b.first_name))
											.append($("<td><input type='hidden' id='designation_id"+num+"' name='designation_id[]' value="+b.designation_id+"></td>").append(b.designation))
											.append($('<td>').append('<select name="attendance[]"><option value="1" selected>Present</option><option value="0">Absent</option></select>'))
