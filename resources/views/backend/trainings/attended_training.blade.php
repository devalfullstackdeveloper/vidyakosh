...
@section('content')
    <div class="card">
        <div class="card-header">
            <h3 class="page-title d-inline">@lang('labels.backend.attendedtraings.title')</h3>
                    ...
                    <div class="table-responsive">
                        <table id="myTable"
                            ...
                            <tr>
                                ...
                                <th>@lang('labels.backend.attendedtraings.fields.title')</th>
                                <th>@lang('labels.backend.attendedtraings.fields.venue')</th>
                                <th>@lang('labels.backend.attendedtraings.fields.organised_by')</th>
                                <th>@lang('labels.backend.attendedtraings.fields.request')</th>
                                <th>@lang('labels.backend.attendedtraings.fields.date')</th>
                            ...
                            @if(isset($users->first_name))
                                @foreach($attended_training as $key=>$item)
                                    @php $key++ @endphp
                                    <tr>
                                        <td>
                                            {{ $key }}
...
<!--                                            <a href="{{url('user/view')}}?trainings={{$item->id}}" class="btn btn-xs btn-warning mb-1">View Detail</a>-->
                                            <a href="javascript:void(0);" class="btn btn-xs btn-warning mb-1 viewDetails" data-id="{{$item->id}}">View Detail</a>
                                        </td>
                                    </tr>
                                @endforeach
                            @endif
