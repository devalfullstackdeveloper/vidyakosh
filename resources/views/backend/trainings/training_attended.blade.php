...
@section('content')
    <div class="card">
        <div class="card-header">
            <h3 class="page-title d-inline">@lang('labels.backend.attended.title')</h3>
                    ...
                    <div class="table-responsive">
                        <table id="myTable"
                            ...
                            <tr>
                                ...
                                <th>@lang('labels.backend.attended.fields.title')</th>
                                <th>@lang('labels.backend.attended.fields.name')</th>
                                <th>Venue</th>
                                <th>To be Organised by</th>
                                <th>@lang('labels.backend.attended.fields.nomination_date')</th>
                                <th>@lang('labels.backend.attended.fields.start')</th>
                                <th>@lang('labels.backend.attended.fields.end')</th>
                            ...
                            <tbody>
                            @foreach($training_attended as $key=>$item)
                                @php $key++ @endphp
                                <tr>
                                    <td>
                                        {{ $key }}
