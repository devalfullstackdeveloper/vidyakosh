...
@section('content')
    <div class="card">
        <div class="card-header">
            <h3 class="page-title d-inline">@lang('labels.backend.approveds.title')</h3>
                    ...
                    <div class="table-responsive">
                        <table id="myTable"
                            ...
                            <tr>
                                ...
                                <th>@lang('labels.backend.approveds.fields.title')</th>
                                <th>Venue</th>
                                <th>To be Organised by</th>
                                <th>@lang('labels.backend.approveds.fields.request')</th>
                                <th>@lang('labels.backend.approveds.fields.requestdate')</th>
                                <th>@lang('labels.backend.approveds.fields.name')</th>
                                <th>@lang('labels.backend.approveds.fields.date')</th>
                                <th>Nomination From</th>
                                <th>@lang('labels.backend.approveds.fields.action')</th>
                            ...
                            @foreach($approved as $key=>$item)
                                ...
                                <tr>
                                    ...
                                    <td>
<!--                                        <a href="{{URL::to('/')}}/user/view?trainings={{$item->crtid}}" class="btn btn-xs btn-warning mb-1"><i class="fa fa-eye"></i></a>-->
