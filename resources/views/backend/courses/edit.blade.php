    ...
    <div class="card-body">
            ...
            <div class="col-12">
                ...
                <div class="form-group row"> 
                    <div class="col-12 col-lg-6 form-group">
                        ...
                        {!! Form::select('ministry_id', $ministry, $ministryArr , ['class' => 'form-control select2', 'multiple' => false, 'required']) !!}
                    </div>
                    <div class="col-12 col-lg-6 form-group">
                    ...
                    <div class="col-12 col-lg-6 form-group">
                        ...
                        {!! Form::select('sub_cat_id', $subcategories, $course->sub_cat_id, ['class' => 'form-control select2 js-example-placeholder-single', 'multiple' => false, 'required']) !!}
                    </div>

                    <div class="col-12 col-lg-6 form-group">
                        <label class="control-label">Course Difficulty</label>
                        {!! Form::select('difficulty_id', $difficulty, $course->difficulty_id, ['class' => 'form-control select2 js-example-placeholder-single', 'multiple' => false, 'required']) !!}
                    </div>

                    <div class="col-12 col-lg-6 form-group">
                        <label class="control-label">Course Type</label>
                        {!! Form::select('course_type_id', $course_type, $course->course_type_id, ['class' => 'form-control select2 js-example-placeholder-single', 'multiple' => false, 'required']) !!}
                    </div>
					
					<div class="col-12 col-lg-6 form-group">
                        <label class="control-label">Designation</label>
						<?//php print_r($coursedesignation);?>
						
 					{!! Form::select('crt_designation_id[]', $designation,  ['class' => 'form-control select2 js-example-placeholder-single', 'id'=>'crt_designation_id', 'multiple' =>true, 'required']) !!}
						
						<!--<select class="form-control select2"  name="crt_designation_id[]" id="crt_designation_id" multiple="true">
                            <option value="">Please Select</option>
							
							@foreach($coursedesignation as $coursedesignationdata)
								<option value="{{$coursedesignationdata->id}}">{{$coursedesignationdata->designation}}</option>
						@endforeach
                        </select>-->
                    </div>
                    ...
                    <div class="col-12 col-lg-6 form-group">
                        ...
                        {!! Form::select('course_enrollment_type_id', $course_enrollment_type, $course->course_enrollment_type_id, ['class' => 'form-control select2 js-example-placeholder-single', 'multiple' => false, 'required']) !!}
                    </div>
        ...
        <div class="row">
			...
			<div class="col-12 col-lg-6 form-group">
                ...
                {!! Form::text('short_name', old('title'), ['class' => 'form-control', 'placeholder' => '', 'required' => '']) !!}
            </div>
            <div class="col-12 col-lg-6 form-group">
