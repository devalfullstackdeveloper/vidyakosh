        ...
        <div class="card-header">
            ...
            @can('course_create')
                <div class="float-right">
					...
					<a href="{{ route('admin.courses-scrom.create') }}"
                       class="btn btn-info">@lang('strings.backend.general.app_add_scrom_package')</a>
                </div>
            @endcan
        </div>
        <div class="card-body">
            <div class="table-responsive">
                ...
                <table id="myTable" class="table table-bordered table-striped @can('course_delete') @if ( request('show_deleted') != 1 ) dt-select @endif @endcan">
                    ...
                    <tr>
						...
						<th>@lang('labels.backend.courses.fields.scormstatus')</th>
                        <th>@lang('labels.backend.courses.fields.coursemode')</th>
            ...
            $('#myTable').DataTable({
                ...
                columns: [
                   ...
                   //{data: "teachers", name: 'teachers'},
					...
					{data: "scormstatus", name: "scormstatus"},
                    {data: "coursemode", name: "coursemode"},
