...
@section('content')
    ...
    {!! Form::open(['method' => 'POST', 'route' => ['admin.courses-scrom.store'], 'files' => true, 'id' => 'mainform']) !!}

    <div class="card">
        <div class="card-header">
            <h3 class="page-title float-left">@lang('labels.backend.courses.create_scrom')</h3>
        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-12 col-lg-4 form-group">
                    {!! Form::label('course_scrom_file',  trans('labels.backend.courses.fields.course_scrom_file'), ['class' => 'control-label']) !!}
                    {!! Form::file('course_scrom_file',  ['class' => 'form-control', 'accept' => '']) !!}
                    {!! Form::hidden('course_scrom_file_max_size', 8) !!}
                    {!! Form::hidden('course_scrom_file_max_width', 4000) !!}
                    {!! Form::hidden('course_scrom_file_max_height', 4000) !!}
                </div>
            </div>
                <div class="row">
            ...
            <div class="row">
                <div class="col-12  text-center form-group">
                    {!! Form::submit(trans('strings.backend.general.app_save'), ['class' => 'btn btn-lg btn-danger', 'id' => 'submit']) !!}
                </div>
            </div>
        </div>
    </div>
...
@push('after-scripts')
    ...
    $(document).ready(function () {
        $("#submit").click(function (event) {
            ...
            axios.post('/user/courses-scrom',formData)
                // .then('res' => {
                //     alert(res.data);
                // })
        });
