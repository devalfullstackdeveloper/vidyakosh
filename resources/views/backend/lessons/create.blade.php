...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="row">
			 ...
			 <div class="row">
                <div class="col-4 form-group">
                    {!! Form::label('lesson_type', trans('labels.backend.lessons.fields.lesson_type'), ['class' => 'control-label']) !!}
                  <select name="lesson_type" id="lesson_type" class="form-control">
					  <option value="1">Self</option>
					  <option value="2" selected="selected">Scrom</option>
					  </select>

                </div>
            </div>
			   
            <div class="row" style="display:none;" id="downloadfile">
                <div class="col-12 form-group">
            ...
            <div class="row" style="display:none;" id="addfile">
                <div class="col-12 form-group">
            ...
            <div class="row" style="display:none;" id="addaudio">
                <div class="col-12 form-group">
            ...
            <div class="row" id="sromfile">
                <div class="col-12 col-lg-12 form-group">
                    {!! Form::label('lesson_scrom_file',  trans('labels.backend.courses.fields.lesson_scrom_file'), ['class' => 'control-label']) !!}
                    {!! Form::file('lesson_scrom_file',  ['class' => 'form-control', 'accept' => 'zip']) !!}
                    {!! Form::hidden('lesson_scrom_file_max_size', 8) !!}
                    {!! Form::hidden('lesson_scrom_file_max_width', 4000) !!}
                    {!! Form::hidden('lesson_scrom_file_max_height', 4000) !!}
                </div>
            </div>
