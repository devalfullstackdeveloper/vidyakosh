...
<div class="card">
    <div class="card-header">
        <h3 class="page-title d-inline">@lang('labels.backend.years.title')</h3>
                ...
                <div class="table-responsive">
                    <div class="d-block">
                        <ul class="list-inline">
                            ...
                            |
                            <li class="list-inline-item">
                                <a href="{{ route('admin.year.index') }}?show_deleted=1"
                    ...
                    <table id="myTable"
                        ...
                        <thead>
                            <tr>
                                ...
                                <th>@lang('labels.backend.years.fields.department_id')</th>
                                <th>@lang('labels.backend.years.fields.name')</th>
                                <th>@lang('labels.backend.years.fields.year')</th>         									
...
<script>
    ...
    $(document).ready(function () {
        var route = '{{route('admin.year.get_data')}}';

        @if(request('show_deleted') == 1)
            route = '{{route('admin.year.get_data',['show_deleted' => 1])}}';
        @endif
        console.log(route);
        $('#myTable').DataTable({
            processing: true,
