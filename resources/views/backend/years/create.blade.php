            ...
            <div class="col-12">
                <div class="form-group row">  
                    <div class="col-12 col-lg-6 form-group">
                        {!! Form::label('z',trans('labels.backend.years.fields.department_id'), ['class' => 'control-label require']) !!}
                    ...
                    <div class="col-12 col-lg-6 form-group">
                        <!--                        {{ html()->label(__('labels.backend.years.fields.name'))->class('form-control-label')->for('name') }}
                                                ...
                                                ->required()
                                                ->autofocus() }} -->
                        {{ html()->label(__('labels.backend.years.fields.name'))->class('form-control-label require')->for('name') }}
                    ...
                    <div class="col-12 col-lg-6 form-group year_1">
                        {{ html()->label(__('labels.backend.years.fields.year'))->class('form-control-label require')->for('year') }}
                        {{ html()->text('year')
                        ->class('form-control yearpicker restrict')
                    ...
                    <div class="col-12 col-lg-6 form-group year_2 d-none"> 
                        <label class="form-control-label require" for="year">Year</label>
