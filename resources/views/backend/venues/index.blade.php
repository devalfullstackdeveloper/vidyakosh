...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
                <h3 class="page-title d-inline">@lang('labels.backend.venues.title')</h3>
                    ...
                    <div class="table-responsive">
                        <div class="d-block">
                            <ul class="list-inline">
                                ...
                                |
                                <li class="list-inline-item">
                                    <a href="{{ route('admin.venue.index') }}?show_deleted=1"
                        ...
                        <table id="myTable"
                            ...
                            <tr>
								...
								<th>@lang('labels.backend.venues.fields.department_id')</th>
								<th>@lang('labels.backend.venues.fields.state')</th>
                                <th>@lang('labels.backend.venues.fields.city')</th>         									
                                <th>@lang('Venue')</th>
                                @if( request('show_deleted') == 1 )
...
@push('after-scripts')
    <script>
        ...
        $(document).ready(function () {
            var route = '{{route('admin.venue.get_data')}}';

            @if(request('show_deleted') == 1)
                route = '{{route('admin.venue.get_data',['show_deleted' => 1])}}';
            @endif
