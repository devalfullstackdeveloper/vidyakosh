...
<div class="card">
    <div class="card-header">
        <h3 class="page-title d-inline">@lang('labels.backend.signings.title')</h3>
        @if(auth()->user()->isAdmin() || (auth()->user()->is_admin == 1 && $officeLocation == 0))
        <div class="float-right">
            <a href="{{ route('admin.signing.create') }}"
                ...
                <div class="table-responsive">
                    <div class="d-block">
                        <ul class="list-inline">
                            ...
                            |
                            <li class="list-inline-item">
                                <a href="{{ route('admin.signing.index') }}?show_deleted=1"
                    ...
                    <table id="myTable"
                        ...
                        <thead>
                            <tr>
                                ...
                                <th>@lang('labels.backend.signings.fields.department_id')</th>
                                <th>@lang('labels.backend.signings.fields.officer_id')</th>
...
<script>
    ...
    $(document).ready(function () {
        var route = '{{route('admin.signing.get_data')}}';

        @if(request('show_deleted') == 1)
            route = '{{route('admin.signing.get_data',['show_deleted' => 1])}}';
        @endif
