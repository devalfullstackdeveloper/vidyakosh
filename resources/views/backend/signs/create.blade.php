            ...
            <div class="col-12">
                ...
                <div class="form-group row">  
                    <div class="col-12 col-lg-6 form-group">
                        {!! Form::label('z',trans('labels.backend.signings.fields.department_id'), ['class' => 'control-label require']) !!}
                    ...
                    <div class="col-12 col-lg-6 form-group">
                        {!! Form::label('z',trans('labels.backend.signings.fields.officer_id'), ['class' => 'control-label require']) !!}
