                        ...
                        <div class="form-group">
                            <div class="input-group toText">
                                <div class="input-group date datepicker" data-date-format="mm-dd-yyyy">
                                    ...
                                    <span class="input-group-addon"><i class="fa fa-calendar dicion" style="padding: 10px;"></i></span>
                                </div>
                            </div>    
                        </div>
                    </div>
     ...
     <!--./box 1-->
            ...
            <div class="card">
                <div class="card-header">
                 <strong>@lang('labels.backend.dashboard.my_courses') </strong>
                      <div class="dropdown pull-right coursesStatusBox">
								...
								<div class="dropdown-menu">
								  ...
								  <a class="dropdown-item" href="{{route('admin.mycourse.ongoingcourses')}}">In Progress ({{count($purchased_courses)}})</a>
								  <a class="dropdown-item" href="{{route('admin.mycourse.ongoingcourses')}}">Yet to be Started ({{count($purchased_courses)}})</a>
								</div>
							</div>  
                    ...
                    <div class="row">
                        @if(auth()->user()->hasRole('student'))
                            ...
                            @if(count($purchased_courses) > 0)
                                ...
                                if($moodle_course_ref_id>0){
                                    $course_id=$moodle_course_ref_id;
                                    $user_id=$logged_in_user['id'];
                                   // echo '<pre>'; print_r( $user_id); print_r( $course_id);echo '</pre>';
