                    ...
                    <div class="col vMiddle">
                        <div class="form-group">
                            <select class="form-control" name="course_year">
                                <option value="">Select Course Status Tracker</option>
                                <option value="1" {{isset($_GET['course_year']) && $_GET['course_year'] =="1"? 'selected':''}}>Current Year Courses </option>
                                <option value="2" {{isset($_GET['course_year']) && $_GET['course_year'] =="2"? 'selected':''}}>Previous Year Courses </option>
                            </select>   
                        </div>
                    </div>
                    <!--/01-->
...
<!--                    <div class="col vMiddle">
                        <div class="form-group">
                            <select class="form-control" name="course_type">
                                ...
                                <option value="1" {{isset($_GET['course_type']) && $_GET['course_type']=="1"? 'selected':''}}>Off the Shell (OTS) Courses  </option>
                                <option value="2" {{isset($_GET['course_type']) && $_GET['course_type']=="2"? 'selected':''}}>In House Courses  </option>
                            </select>   
                        </div>
                    </div>-->
                    <!--/01-->
                        ...
                        <div class="form-group">
                            <div class="input-group toText">
                                <div class="input-group date">
                                    <input class="form-control" id="start_date" name="start_date" type="text" readonly="" value="{{isset($_GET['start_date']) ? $_GET['start_date']:''}}">
                    ...
                    <div class="col vMiddle">
                        <div class="form-group">  
                            <div class="input-group">
                                <div class="input-group date">
                                    <input class="form-control" type="text" readonly="" name="end_date" id="end_date" value="{{isset($_GET['end_date']) ? $_GET['end_date']:''}}">
                    ...
                    <div class="col vMiddle text-left">
                        ...
                        <a href="javascript:void(0);" onclick="reset();" class="btn btn-info">Reset</a>
                    </div>
                    <!--/01-->
        ...
        <div class="card mt-4">               
            ...
            <div class="filterPanel f-box-2">
                <div class="row totalViewSection" style="margin-bottom:0">
                    <!--box 1-->   
                    <div class="col showSingle" target="1">
                        <div class="cardPanel" >
                    ...
                    <div class="col showSingle" target="2">
                        <div class="cardPanel">
                            <i class="fa fa-check float-left"></i>
                            {{$totCompleted}}        
                            <span>Completed</span> 
                    ...
                    <div class="col showSingle" target="3">
                        <div class="cardPanel">
                            <i class="fa fa-spinner float-left"></i>
                            {{$totInProgress}}
                            <span>In Progress</span> 
                    ...
                    <!--./box 1-->
                    <!--box 1-->   
                    <div class="col showSingle" target="4">
                        ...
                        <div class="col-md-3">
                            <div class="best-course-pic-text position-relative border">
                                <div class="best-course-pic position-relative overflow-hidden"
                                     ...
                                     @if(($item->difficulty_id)==($leveldata->id))
                                ...
                                <div class="best-course-text d-inline-block w-100 p-2">
                                    <div class="course-title mb20 headline relative-position">
                                        ...
                                        <h5>
                                            ...
                                            <a href="javascript:void(0);"> @if(strlen(strip_tags($item->title))>25){{substr(strip_tags(ucwords($item->title)), 0, 22)}}...@else{{strip_tags(ucwords($item->title))}}@endif</a>
                                        </h5>
                                        @endif
                                        @if($completionArr[$item->id]['active'] > 0)
                                        <h5>
                                            <a class="customtooltip" title="{{$item->title}}" href="{{ route('courses.show', [$item->slug]) }}"> @if(strlen(strip_tags($item->title))>25){{substr(strip_tags(ucwords($item->title)), 0, 22)}}...@else{{strip_tags(ucwords($item->title))}}@endif</a>
                                        </h5>
                                        @endif
                                    </div>
            ...
            <div id="div2" class="targetDiv" style="display:none;">
                <div class="row">
                    @foreach($cmptdcourse as $completeddata)
                    <div class="col-md-3">
                        <div class="best-course-pic-text position-relative border">
                            <div class="best-course-pic position-relative overflow-hidden"
                                 @if($item->course_image != "") style="background-image: url({{asset('storage/uploads/'.$completeddata->course_image)}})" @endif>

                                 @if(isset($level))
                                 @foreach($level as $leveldata)
                                 @if(($completeddata->difficulty_id)==($leveldata->id))
                            ...
                            <div class="best-course-text d-inline-block w-100 p-2">
                                <div class="course-title mb20 headline relative-position">
                                    @if($completionArr[$completeddata->id]['active'] == 0)
                                    <h5>

                                        <a class="customtooltip tooltipstered" title="{{$completeddata->title}}" href="javascript:void(0);"> @if(strlen(strip_tags($completeddata->title))>25){{substr(strip_tags(ucwords($completeddata->title)), 0, 22)}}...@else{{strip_tags(ucwords($completeddata->title))}}@endif</a>
                                    </h5>
                                    @endif
                                    @if($completionArr[$completeddata->id]['active'] > 0)
                                    <h5>
                                        <a class="customtooltip tooltipstered" title="{{$completeddata->title}}" href="{{ route('courses.show', [$completeddata->slug]) }}"> @if(strlen(strip_tags($completeddata->title))>25){{substr(strip_tags(ucwords($completeddata->title)), 0, 22)}}...@else{{strip_tags(ucwords($completeddata->title))}}@endif</a>
                                    </h5>
                                    @endif
                                </div>
                                ...
                                <div class="course-meta d-inline-block w-100 ">
                                    <div class="d-inline-block w-100 0 mt-2">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <span class="course-category">
                                                    <!-- <div class="course-rate ul-li"> -->
                                                    <h6>Average Rating</h6>        
                                                    @if(isset($completeddata->rating))
                                                    <ul class="ratingStar" style="float: right;position: relative;margin-bottom: -20px;top: -25px;">
                                                        @for($i=1; $i<=(int)$item->completeddata; $i++)
                                                        <li><i class="fa fa-star"></i></li>
                                                        @endfor
                                                    </ul>
                                                    @endif
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <span class="course-author float-right">
                                                    {{ $completeddata->students()->count() }}
                                                    @lang('labels.backend.dashboard.students')
                                                </span>
                                                <span class="course-category">
                                                    @if($completionArr[$completeddata->id]['completion_days'] > 0)
                                                    Will expire on {{$completionArr[$item->id]['completion_date']}}
                                                    @endif
                                                    @if($completionArr[$completeddata->id]['active'] == 0)
                                                    INACTIVE
                                    ...
                                    @if($completeddata->progress() == 100)
                                    @if(!$completeddata->isUserCertified())
                                    <form method="post"
                                          action="{{route('admin.certificates.generate')}}">
                                        @csrf
                                        <input type="hidden" value="{{$completeddata->id}}"
                                               name="course_id">
                                        <button class="btn btn-success btn-block text-white mb-3 text-uppercase font-weight-bold"
                                                id="finish">@lang('labels.frontend.course.finish_course')</button>
                                    </form>
...
<!--            <div id="div3" class="targetDiv" style="display:none;">
            ...
            <div id="div3" class="targetDiv" style="display:none;">
                <div class="row">
                    @foreach($inProgCourse as $inprogressdata)
                    <div class="col-md-3">
                        <div class="best-course-pic-text position-relative border">
                            <div class="best-course-pic position-relative overflow-hidden"
                                 @if($item->course_image != "") style="background-image: url({{asset('storage/uploads/'.$inprogressdata->course_image)}})" @endif>

                                 @if(isset($level))
                                 @foreach($level as $leveldata)
                                 @if(($inprogressdata->difficulty_id)==($leveldata->id))
                            ...
                            <div class="best-course-text d-inline-block w-100 p-2">
                                <div class="course-title mb20 headline relative-position">
                                    @if($completionArr[$inprogressdata->id]['active'] == 0)
                                    <h5>

                                        <a class="customtooltip tooltipstered" title="{{$inprogressdata->title}}" href="javascript:void(0);"> @if(strlen(strip_tags($inprogressdata->title))>25){{substr(strip_tags(ucwords($inprogressdata->title)), 0, 22)}}...@else{{strip_tags(ucwords($inprogressdata->title))}}@endif</a>
                                    </h5>
                                    @endif
                                    @if($completionArr[$inprogressdata->id]['active'] > 0)
                                    <h5>
                                        <a class="customtooltip tooltipstered" title="{{$inprogressdata->title}}" href="{{ route('courses.show', [$inprogressdata->slug]) }}"> @if(strlen(strip_tags($inprogressdata->title))>25){{substr(strip_tags(ucwords($inprogressdata->title)), 0, 22)}}...@else{{strip_tags(ucwords($inprogressdata->title))}}@endif</a>
                                    </h5>
                                    @endif
                                </div>
                                ...
                                <div class="course-meta d-inline-block w-100 ">
                                    <div class="d-inline-block w-100 0 mt-2">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <span class="course-category">
                                                    <!-- <div class="course-rate ul-li"> -->
                                                    <h6>Average Rating</h6>        
                                                    @if(isset($inprogressdata->rating))
                                                    <ul class="ratingStar" style="float: right;position: relative;margin-bottom: -20px;top: -25px;">
                                                        @for($i=1; $i<=(int)$item->completeddata; $i++)
                                                        <li><i class="fa fa-star"></i></li>
                                                        @endfor
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <span class="course-author float-right">
                                                    {{ $inprogressdata->students()->count() }}
                                                    @lang('labels.backend.dashboard.students')
                                                </span>
                                                <span class="course-category">
                                                    @if($completionArr[$inprogressdata->id]['completion_days'] > 0)
                                                    Will expire on {{$completionArr[$item->id]['completion_date']}}
                                                    @endif
                                                    @if($completionArr[$inprogressdata->id]['active'] == 0)
                                                    INACTIVE
                                    ...
                                    @if($inprogressdata->progress() == 100)
                                    @if(!$inprogressdata->isUserCertified())
                                    <form method="post"
                                          action="{{route('admin.certificates.generate')}}">
                                        @csrf
                                        <input type="hidden" value="{{$inprogressdata->id}}"
                                               name="course_id">
                                        <button class="btn btn-success btn-block text-white mb-3 text-uppercase font-weight-bold"
                                                id="finish">@lang('labels.frontend.course.finish_course')</button>
                                    </form>
                            ...
                            <div class="best-course-text d-inline-block w-100 p-2">
                                <div class="course-title mb20 headline relative-position">
                                    ...
                                    <h5>
                                        ...
                                        <a class="customtooltip tooltipstered" title="{{$item->title}}" href="javascript:void(0);">@if(strlen(strip_tags($item->title))>25){{substr(strip_tags(ucwords($item->title)), 0, 22)}}...@else{{strip_tags(ucwords($item->title))}}@endif</a>
                                    </h5>
                                    @endif
                                    @if($completionArr[$item->id]['active'] > 0)
                                    <h5>
                                        <a class="customtooltip tooltipstered" title="{{$item->title}}" href="{{ route('courses.show', [$item->slug]) }}">@if(strlen(strip_tags($item->title))>25){{substr(strip_tags(ucwords($item->title)), 0, 22)}}...@else{{strip_tags(ucwords($item->title))}}@endif</a>
                                    </h5>
                                    @endif
                                </div>
...
<script>
    ...
    function reset(){
        $('select[name="course_year"]').val("");
        $('select[name="course_type"]').val("");
        $('select[name="start_date"]').val("");
        $('select[name="end_date"]').val("");
    }
</script>
@endsection
