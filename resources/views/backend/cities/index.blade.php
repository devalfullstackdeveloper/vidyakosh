...
<div class="card">
    <div class="card-header">
        <h3 class="page-title d-inline">@lang('labels.backend.cities.title')</h3>
                ...
                <div class="table-responsive">
                    <div class="d-block">
                        <ul class="list-inline">
                            ...
                            |
                            <li class="list-inline-item">
                                <a href="{{ route('admin.cities.index') }}?show_deleted=1"
                    ...
                    <table id="myTable"
                        ...
                        <thead>
                            <tr>
                                ...
                                <th>@lang('labels.backend.states.fields.state')</th>
                                <th>@lang('labels.backend.cities.fields.city')</th>
                                @if( request('show_deleted') == 1 )
...
<script>
    ...
    $(document).ready(function () {
        var route = '{{route('admin.cities.get_data')}}';

        @if(request('show_deleted') == 1)
            route = '{{route('admin.cities.get_data',['show_deleted' => 1])}}';
        @endif
        console.log(route)
        $('#myTable').DataTable({
            processing: true,
