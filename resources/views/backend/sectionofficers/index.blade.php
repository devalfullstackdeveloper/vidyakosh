...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
                <h3 class="page-title d-inline">@lang('labels.backend.sectionofficers.title')</h3>
            @can('course_create')
                    ...
                    <div class="table-responsive">
                        <div class="d-block">
                            <ul class="list-inline">
                                ...
                                |
                                <li class="list-inline-item">
                                    <a href="{{ route('admin.section.index') }}?show_deleted=1"
                        ...
                        <table id="myTable"
                            ...
                            <tr>
								...
								<th>@lang('labels.backend.sectionofficers.fields.department_id')</th>
							    <th>@lang('labels.backend.sectionofficers.fields.officer_id')</th>
...
@push('after-scripts')
    <script>
        ...
        $(document).ready(function () {
            var route = '{{route('admin.section.get_data')}}';

            @if(request('show_deleted') == 1)
                route = '{{route('admin.section.get_data',['show_deleted' => 1])}}';
            @endif
