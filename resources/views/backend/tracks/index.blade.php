...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
                <h3 class="page-title d-inline">@lang('labels.backend.tracks.title')</h3>
                    ...
                    <div class="table-responsive">
                        <div class="d-block">
                            <ul class="list-inline">
                                ...
                                |
                                <li class="list-inline-item">
                                    <a href="{{ route('admin.track.index') }}?show_deleted=1"
                        ...
                        <table id="myTable"
                            ...
                            <tr>
								...
								<th>@lang('labels.backend.tracks.fields.department_id')</th>
								<th>@lang('labels.backend.tracks.fields.name')</th>
                                        									
                                <th>@lang('labels.backend.tracks.fields.status')</th>
                                @if( request('show_deleted') == 1 )
...
@push('after-scripts')
    <script>
        ...
        $(document).ready(function () {
            var route = '{{route('admin.track.get_data')}}';

            @if(request('show_deleted') == 1)
                route = '{{route('admin.track.get_data',['show_deleted' => 1])}}';
            @endif
