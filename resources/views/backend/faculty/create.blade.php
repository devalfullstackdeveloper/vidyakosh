...
@section('content')
{{ html()->form('POST', route('admin.faculty.store'))->acceptsFiles()->class('form-horizontal')->open() }}
<div class="card">
    <div class="card-header">
        <h3 class="page-title d-inline">@lang('labels.backend.faculty.create')</h3>
            ...
            <div class="col-12">
                ...
                <div class="form-group row">  
                    ...
                    <div class="col-12 col-lg-6 form-group">
                        ...
                        {!! Form::select('institute_industry_id', $institute_industry, old('institute_industry'), ['class' => 'form-control select2 js-example-placeholder-single', 'multiple' => false, 'required']) !!}
<!--                        <select name="institute_industry_id" id="institute_industry_id" class="form-control">
                            <option value="">Select Institute Industry Name</option>
                        </select>-->
                    </div>
                    <div class="col-12 col-lg-6 form-group">
                    ...
                    <div class="col-12 col-lg-6 form-group">
                        ...
                        {!! Form::select('subject_id[]', $subject, old('subject_id'), ['class' => 'form-control select2 js-example-placeholder-single', 'multiple' => true, 'required']) !!}
                    </div>
