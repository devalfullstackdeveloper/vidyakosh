...
<div class="card">
    <div class="card-header">
        <h3 class="page-title d-inline">@lang('labels.backend.faculty.title')</h3>
                ...
                <div class="table-responsive">
                    <div class="d-block">
                        <ul class="list-inline">
                            ...
                            |
                            <li class="list-inline-item">
                                <a href="{{ route('admin.faculty.index') }}?show_deleted=1"
                    ...
                    <table id="myTable" class="table table-bordered table-striped @if(auth()->user()->isAdmin()) @if ( request('show_deleted') != 1 ) dt-select @endif @endcan">
                        <thead>
                            <tr>
                                ...
                                <th>@lang('labels.backend.faculty.fields.department_id')</th>
                                <th>@lang('labels.backend.faculty.fields.institute_industry_id')</th>
                                <th>@lang('labels.backend.faculty.fields.name')</th>         									
                                <th>@lang('labels.backend.faculty.fields.email')</th>  									
...
<script>
    ...
    $(document).ready(function () {
        var route = '{{route('admin.faculty.get_data')}}';

        @if(request('show_deleted') == 1)
            route = '{{route('admin.faculty.get_data',['show_deleted' => 1])}}';
        @endif
        ...
        $('#myTable').DataTable({
            ...
            columns: [
                ...
                {data: "institute_industry_name", name: 'institute_industry_name'}, 
                {data: "name", name: 'name'}, 
