...
<div class="card">
    <div class="card-header">
        <h3 class="page-title d-inline">@lang('labels.backend.subject.title')</h3>
                ...
                <div class="table-responsive">
                    <div class="d-block">
                        <ul class="list-inline">
                            ...
                            |
                            <li class="list-inline-item">
                                <a href="{{ route('admin.subject.index') }}?show_deleted=1"
                    ...
                    <table id="myTable" class="table table-bordered table-striped @if(auth()->user()->isAdmin()) @if ( request('show_deleted') != 1 ) dt-select @endif @endcan">
                        <thead>
                            <tr>
                                ...
                                <th>@lang('labels.backend.subject.fields.name')</th>
                                @if( request('show_deleted') == 1 )
...
<script>
    ...
    $(document).ready(function () {
        var route = '{{route('admin.subject.get_data')}}';

        @if(request('show_deleted') == 1)
            route = '{{route('admin.subject.get_data',['show_deleted' => 1])}}';
        @endif
