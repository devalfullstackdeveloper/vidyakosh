...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
                <h3 class="page-title d-inline">@lang('labels.backend.designations.title')</h3>
                    ...
                    <div class="table-responsive">
                        <div class="d-block">
                            <ul class="list-inline">
                                ...
                                |
                                <li class="list-inline-item">
                                    <a href="{{ route('admin.designations.index') }}?show_deleted=1"
                        ...
                        <table id="myTable"
                            ...
                            <tr>
								...
								<th>@lang('labels.backend.designations.fields.department_id')</th>
							
                                <th>@lang('labels.backend.designations.fields.designation')</th>         									
...
@push('after-scripts')
    <script>
        ...
        $(document).ready(function () {
            var route = '{{route('admin.designations.get_data')}}';

            @if(request('show_deleted') == 1)
                route = '{{route('admin.designations.get_data',['show_deleted' => 1])}}';
            @endif
