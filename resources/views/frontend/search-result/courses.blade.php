                ...
                <div class="col-lg-12">
                    <div class="course-tab-wrap d-flex align-items-center">
                        <ul class="course-tab-list nav nav-tabs align-items-center" role="tablist"
                            ...
                            <li><span class="courses-showing-text">{{$coursecountt}} Courses Found</span></li>
                        </ul>
			...
			<ul class="breadcrumb">
				<?php $segments = ''; ?>
				  ...
				  @foreach(Request::segments() as $segment)
					...
					<li>{{$subcategoryname->name}}</li>
					@endif
				    @if(!empty($sortbytrend))
					<li>{{$sortbytrend}}</li>
				    @endif
					@if(!empty($courselevel))
					<li>{{$courselevel->name}}</li>
					@endif
					@if(!empty($designations))
					<li>{{$designations->designation}}</li>
				    @endif
				    @if(!empty($coursetype))
				    @if($coursetype==1)
					<li>Mandatory</li>
                                                ...
                                                <ul class="course__list d-flex">
                                                    <li>
                                                        <span class="meta__date">
                                                            <i class="la la-play-circle"></i> {{$course->chapterCount()}} Lectures
                                                        </span>
                                                    </li>
                                                    <li>
                                                        <span class="meta__date">
