        ...
        <div class="container">
            <div class="page-breadcrumb-content text-center">
                <div class="page-breadcrumb-title">
                    <h2 class="breadcrumb-head black bold"><span>ertewrtetet{{$course->title}}</span></h2>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-9">
                                ...
                                <h3><a href="{{ route('courses.show', [$course->slug]) }}"><b>{{$course->title}}</b></a>
                                    @if($course->trending == 1)
                                        <span class="trend-badge text-uppercase bold-font"><i
                                                    class="fa fa-bolt"></i> @lang('labels.frontend.badges.trending')</span>
                                    @endif
                    ...
                    <div class="affiliate-market-guide mgt-30">
                    ...
                    <div class="couse-comment">
                        <div class="blog-comment-area ul-li about-teacher-2 mr-b-20">
...
?>
                              <a href="http://companydemo.in/apps/moodle/autologin.php?userid={{$user_id_details}}&course={{$course->id}}"
                                   class="genius-btn btn-block text-white  gradient-bg text-center text-uppercase  bold-font" target="_blank">
                        ...
                        <div class="couse-feature ul-li-block">
                            <ul>
                                ...
                                <li> @lang('labels.frontend.course.category') 
                                    <span>{{$course->category->name}}</span></li>
