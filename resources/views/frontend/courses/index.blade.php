        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="breadcrumb-content">
                    <h2 class="breadcrumb__title">@if(isset($category)) {{$category->name}} @else E-Learning @lang('labels.frontend.course.courses') @endif </h2>
                 <!--    <ul class="breadcrumb__list">
                        <li class="active__list-item"><a href="{{url('/')}}">home</a></li>
                        <li class="active__list-item">@if(isset($category)) {{$category->name}} @else E-Learning @lang('labels.frontend.course.courses') @endif </li>
...
<!-- ================================ 
 ...
 <!-- ================================
       START FUNFACT AREA
================================= -->
<!--<section class="funfact-area text-center pb-4">
    <div class="container">
        <div class="funfact-row">
			 <div class="funfact-item">
                <div class="funfact-inner-item">
                    ...
                    <p class="funfact__meta">Learners</p>
                </div>
            </div>
            <div class="funfact-item">
                <div class="funfact-inner-item">
...
<div class="section-divider"></div>     
 ...
 <!--======================================
        START COURSE AREA
======================================-->
<section class="course-area course-area4 pt-4 pb-4">
                ...
                <div class="col-lg-12">
                    <div class="course-tab-wrap d-flex align-items-center">
                        <ul class="course-tab-list nav nav-tabs align-items-center" role="tablist"
                            ...
                            <li><span class="courses-showing-text">{{$coursescountt}} Courses Found</span></li>
                        </ul>
                        ...
                        <div role="tabpanel" class="tab-pane fade show active" id="tab1">
                            <div class="row course-block">
                                ...
                                <div class="course-img">
									...
									@if(($course->difficulty_id)==($leveldata->id))
                                ...
                                <div class="course-content">
                                    ...
                                    <h3 class="course__title">
                                        <a href="{{ route('courses.show', [$course->slug]) }}" class="customtooltip" title="{{$course->title}}">
                                ...
                                <div class="col-lg-12">
                                    <div class="course-item"> 
                                        ...
                                        <div class="course-content">
                                            ...
                                            <h3 class="course__title">
                                                <a href="{{ route('courses.show', [$course->slug]) }}" class="customtooltip" title="{{$course->title}}"> @if(strlen(strip_tags($course->title))>25){{substr(strip_tags(ucwords($course->title)), 0, 22)}}...@else{{strip_tags(ucwords($course->title))}}@endif</a>
                                            </h3>
                                            <p class="course__author">
                                                 {{ str_limit(strip_tags($course->description), 100) }}
                                                    @if(strlen(strip_tags($course->description)) > 100)
                                                ...
                                                <ul class="course__list d-flex">
                                                    <li>
                                                        <span class="meta__date">
                                                            <i class="la la-play-circle"></i> {{$course->chapterCount()}} Lessons
                                                        </span>
                                                    </li>
                                                    <li>
                                                        <span class="meta__date">
                ...
                <div class="col-lg-4">
                    <div class="sidebar">
                        ...
                        <div class="side-bar-widget  first-widget">
							<form action="{{route('search-course')}}" method="get">
							<div class="courses-ordering mb20"  style="margin-right:10px;">
                                <select class="target-course" name="selecttrack" id="selecttrack">
                                <option value="">Select Track</option>
                               @if(count($tracks)>0)
                                @foreach($tracks as $tracksdata)
                                <option value="{{$tracksdata->id}}">{{$tracksdata->name}}</option>
                                @endforeach
                                @endif 
                                </select>
                            </div>
							<div class="courses-ordering mb20"  style="margin-right:10px;">
                                <select class="target-course" name="category" id="category_id">
                                <option value="">Select Category</option>
                                </select>
                            </div>
							<div class="courses-ordering mb20"  style="margin-right:10px;">
                                <select class="target-course" name="subcategory" id="sortbycategory">
                            ...
                            <!---<div class="listing-filter-form pb30">-->
									...
									<!--<div class="courses-ordering mb20"  style="margin-right:10px;">
										<select id="" name="sortbyrating" class="target-course">
											<option value="">Ratings by</option>
								...
								<div class="courses-ordering mb20"  style="margin-right:10px;">
                            <select id="" name="sortbytrend" class="target-course">
                             <option value="">@lang('labels.frontend.course.sort_by')</option>
                                <option value="">@lang('labels.frontend.course.none')</option>
                                <option value="popular">@lang('labels.frontend.course.popular')</option>
                                <option value="trending">@lang('labels.frontend.course.trending')</option>
								...
								<div class="courses-ordering mb20"  style="margin-right:10px;">
									  <select class="target-course" id="" name="courselevel" class="target-course">
								...
								<div class="courses-ordering mb20"  style="margin-right:10px;">
									  <select class="target-course" id="" name="designation" class="target-course">
								...
								<div class="courses-ordering mb20"  style="margin-right:10px;">
									  <select class="target-course" id="" name="coursetype" class="target-course">
										  <option value="">Select Course type</option>
										 <option value="1">Mandatry</option>
                        ...
                        <!--<div class="sidebar-widget rating-widget">
                            ...
                            <ul class="rating__list">
                                ...
                                <li>
                                    ...
                                    <label class="review-label">
                                        <input type="radio" id="review_radio" value= "4" name="review-radio">
                                        <span class="review-mark"></span>
                                    </label>
                                </li>
                                <li>
                                    ...
                                    <label class="review-label">
                                        <input type="radio" id="review_radio" value= "3" name="review-radio">
                                        <span class="review-mark"></span>
                                    </label>
                                </li>
                                <li>
                                    ...
                                    <label class="review-label">
                                        <input type="radio" id="review_radio" value= "2" name="review-radio">
                                        <span class="review-mark"></span>
                                    </label>
                                </li>
                                <li>
                                    ...
                                    <label class="review-label">
                                        <input type="radio" id="review_radio" value= "1" name="review-radio">
                                        <span class="review-mark"></span>
                                    </label>
                                </li>
                            </ul>
...
//----------------------sort by level------------------------------//
 ...
 //-------------------------sort by ratting--------------------------------//  
 $(document).on('click', '#review_radio', function () {
                 var id = $(this).val();
                     if (id != "") { 
                     location.href = "{{url('/searchCoursebyrate/')}}"+"/"+id;
                    //alert(url);
                } 
            });   
//------------------------select category from track------------------------------------------//
       $(document).on('change', '#selecttrack', function () {
                var selecttrack = $(this).val();
            if(selecttrack) {
                $.ajax({
                    url: 'searchcategory/'+selecttrack,
                    type: "GET",
                    dataType: "json",
                    success:function(data) {
                        //  alert(data); exit;
                        
                        $('select[name="category"]').empty().append('<option value="">Select Category</option>');
...
//----------------------------------------------Select subcategory from category------------------------------//
         $(document).on('change', '#category_id', function () {
            ...
            if(selecttrack) {
                $.ajax({
                    url: 'searchsubcategory/'+selectcategory,
                    type: "GET",
                    dataType: "json",
                    success:function(data) {
