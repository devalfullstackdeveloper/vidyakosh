...
@section('content')
  ...
  <!--banner section-->
       <div class="bannerInnerSection"> 
       <div class="container">
       <div class="row">
       <div class="col-12 col-lg-9">
       <h2>{{$lesson->course->title}}</h2>
        <h3>{{$lesson->course->description}}</h3>

<div class="starMarkingPanel"> <span class="badge-accented">Ratings</span> 
    <div class="starMarking">
		@for($i=1; $i<=(int)$lesson->course->rating; $i++)
			<span class="fa fa-star"></span>
		@endfor
        </div>
	

<span class="mr-20">({{(int)$lesson->course->rating}} Ratings)</span>
{{ $lesson->course->students()->count() }}  Enrolled </div>
</div>
</div>
    </div>    
        </div>
                    ...
                    <div class="course-details-item border-bottom-0 mb-0">
                        ...
                        @if ($test_exists)
                            <div class="course-single-text">
                                ...
                                <div class="course-details-content">
                                    <p class="boxAreaPanel"> {!! $lesson->full_text !!} </p>
                                </div>
                            </div>
                            <hr/>
                        ...
                        @else
                            <div class="course-single-text">
						 	...
						 	@if($lesson->scorm_lesson == 1)
                            <div class="course-single-text">
                                <div class="course-details-content">
                                    <a href="javascript:;" onClick="PopUpWindows('{{config('app.scorm_url')}}launch/index.php?cid={{$lesson->lessoncode}}&lid={{Auth::user()->id}}&type=lesson','Launcher');"  title="Launch Course" class="btn btn-success text-white mb-3 text-uppercase font-weight-bold">@lang('labels.backend.courses.scorm_lesson')</a>
                                    {{-- <a href="{{config('app.scorm_url')}}launch/index.php?cid={{$lesson->lessoncode}}&lid={{Auth::user()->id}}&type=lesson">{{$lesson->title}}</a> --}}
                                </div>
                            </div>
                            @endif
                        @endif
  ...
  <div class="course-single-pic mb20"> <img src="http://192.168.1.16/vidyakosh/public/storage/uploads/1575720592-slider1.jpg" alt=""> </div>
                        ...
                        <div class="course-details-category ul-li">
                            ...
                            <h3 class="hdText">@lang('labels.frontend.course.course_timeline')</h3>
                   ...
                   @foreach($lesson->course->teachers as $key=>$teacher)
                           ...
                           {{$teacher->full_name}}@if($key < count($lesson->course->teachers )), @endif
                                ...
                                <li>@lang('labels.frontend.course.progress') test <span> <b> {{ $lesson->course->progress()  }}
