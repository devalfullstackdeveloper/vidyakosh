...
class NominationsController extends Controller
{
    ...
    { 
        ...
        //return view('backend.nominations.index', compact('venues'));
		return view('backend.nominations.index');
    }
    ...
    public function create()
    {
	   ...
	   $training_types = Training_types::where('status', '=', 1)->pluck('title', 'id')->prepend('Please select', '');
	   
	   //return view('backend.venues.create',compact('department','state','cities'));
		return view('backend.nominations.create',compact('departments','training_types'));
	}
    ...
    $venues->save();
    return redirect()->route('admin.nominations.index')->withFlashSuccess(trans('alerts.backend.general.created'));
    }
    ...
    public function edit($id)
    {
	   ...
	   return view('backend.nominations.edit');
    }
    ...
    public function destroy($id)
    {
       ...
       return redirect()->route('admin.nomations.index')->withFlashSuccess(trans('alerts.backend.general.deleted'));
    }
 ...
 public function departmentFilter($id)
	...
	public function trainingFilter($id)
    {
        $trainingtypes = DB::table("training_types")
                    ...
                    ->select("title","id")
                    ->pluck('title','id');
                return json_encode($trainingtypes);
    }
