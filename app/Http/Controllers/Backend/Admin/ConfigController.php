...
class ConfigController extends Controller
{
    ...
    {
        return view('backend.settings.usermanual');
    }
	
	
    public function contactUs()
    {
        return view('backend.settings.contactus');
    }
...
///////////////////////////////////////////////////////////////////////addtional Default Setting
    ...
    public function getDefaultSettings()
    {
     ...
     return view('backend.settings.default',compact('ministry'));
    }
	
	
	public function saveDefaultSettings(Request $request)
    {
      $settingmanage = SettingManage::create($request->all());
      $settingmanage->save();
     return back()->withFlashSuccess(__('alerts.backend.general.updated'));
    }
	...
	{
	//return "hello";
		$UserFeedbacks = DB::table('UserFeedbacks')->get();
		return view('backend.userfeedback.index',compact('UserFeedbacks'));
	}
