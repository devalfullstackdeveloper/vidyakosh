...
class MinistryController extends Controller
{
    ...
    public function index()
    {
        ...
        if (request('show_deleted') == 1) {
			...
			$users =DB::table('ministry')->orderBy('id', 'DESC')->get();
           // $users = User::role('teacher')->get();
        }

        return view('backend.ministry.index', compact('users'));
    }
    ...
    public function getData(Request $request)
    {
        ...
        if (request('show_deleted') == 1) {
			...
			$teachers =DB::table('ministry')->orderBy('id', 'DESC')->get();
...
//       $request = $this->saveFiles($request);
    ...
    public function edit($id)
    {
        ...
        return view('backend.ministry.edit', compact('teacher'));
    }
    ...
    public function show($id)
    {
        ...
        return view('backend.ministry.show', compact('teacher'));
    }
    ...
    public function restore($id)
    {
        ...
        return redirect()->route('admin.ministry.index')->withFlashSuccess(trans('alerts.backend.general.restored'));
    }
