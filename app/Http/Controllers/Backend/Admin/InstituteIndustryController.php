...
class InstituteIndustryController extends Controller
{
    /**
    ...
    {
        $instituteindustries = InstituteIndustry::all();
        ...
        return view('backend.institute-industry.index', compact('instituteindustries', 'officeLocation')); 
    }
