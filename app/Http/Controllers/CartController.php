...
class CartController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view($this->path . '.cart.checkout', compact('courses', 'bundles','total','taxData','ministry','departments','allministry','alldepartments','logo'));
    }
    ...
    public function addToCart(Request $request)
    {
        ...
        Session::flash('success', trans('labels.frontend.cart.product_added','ministry','departments','allministry','alldepartments','logo'));
        return back();
    }
    ...
    public function checkout(Request $request)
    {
        ...
        return view($this->path . '.cart.checkout', compact('courses','total','taxData','ministry','departments','allministry','alldepartments','logo'));
    }
