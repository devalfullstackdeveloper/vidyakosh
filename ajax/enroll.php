...
$columns = array(
	...
	array( 'db' => 'user_email',   'dt' => 3 ),
	 ...
	 array(
		...
		'dt'        => 8,
		'formatter' => function( $d, $row ) {
			return '<a href="enroll.php?cid='.$_SESSION["enrollcid"].'&delete='.$row["id"].'" onclick="javascript:return confirm(&#39;Are you sure you want to Delete ?&#39;)" class="btn mini red"><i class="icon-minus"></i> Delete</a> <div class="btn-group"> <a data-close-others="true" data-toggle="dropdown" href="#" class="btn mini green"> Course Status <i class="icon-angle-down"></i> </a>
                              <ul class="dropdown-menu pull-right">
                                
                             
                                <li><a href="enroll.php?cid='.$_SESSION["enrollcid"].'&status=complete&id='.$row["id"].'">Complete&nbsp;&nbsp; </a> </li>
                                <li><a href="enroll.php?cid='.$_SESSION["enrollcid"].'&status=in-complete&id='.$row["id"].'">In-Complete&nbsp;&nbsp; </a> </li>
