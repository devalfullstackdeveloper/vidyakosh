...
Route::group([
    ...
    Route::group(['namespace' => 'User'], function () {
		...
		/////////////////////////////////////////////////////////////////////////ajax-routes
		Route::get('user/department-ajax/{id}', [UserController::class, 'departmentFilter'])->name('user.department-ajax');
		Route::get('user/office-ajax/{id}', [UserController::class, 'officeFilter'])->name('user.office-ajax');
		Route::get('user/designation-ajax/{id}/{departmentid}', [UserController::class, 'designationFilter'])->name('user.designation-ajax');
		Route::get('user/showuser', [UserController::class, 'showuser'])->name('user.showuser');	
        Route::post('user/updateuser', [UserController::class, 'updateuser'])->name('user.updateuser');	
        	
        Route::get('user/user-status/{id}', [UserController::class, 'userstatus'])->name('user.user-status');
        /*
         * Specific User
         */
