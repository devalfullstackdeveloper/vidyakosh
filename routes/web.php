...
//==== Messages Routes =====//
	...
	Route::get('sendemail', 'Frontend\HomeController@sendemail')->name('sendemail');
...
Route::get('trendcourse', 'Frontend\HomeController@trendcourse')->name('trendcourse');
Route::get('pilofselflearning', 'Frontend\HomeController@pilofselflearning')->name('pilofselflearning');
Route::get('beneficiaries', 'Frontend\HomeController@beneficiaries')->name('beneficiaries');
Route::get('beneficiaries/beneficiaries-ajax', 'Frontend\HomeController@beneficiaries_ajax')->name('beneficiaries_ajax');
Route::get('analytics', 'Frontend\HomeController@analytics')->name('analytics');
Route::get('designationid/{id}', 'Frontend\HomeController@designationid')->name('designationid');
Route::get('training_charts/{charttype}/{id}/{designationid}', 'Frontend\HomeController@training_charts')->name('training_charts');

Route::get('visitorcount', 'Frontend\HomeController@visitorcount')->name('visitorcount');
...
Route::get('/searchCoursebycat/{id}', ['uses' =>'CoursesController@searchCoursebycat', 'as'=>'searchCoursebycat']);
Route::get('/searchCoursebylevel/{id}', ['uses' =>'CoursesController@searchCoursebylevel', 'as'=>'searchCoursebylevel']);
Route::get('/searchCoursebyrate/{id}', ['uses' =>'CoursesController@searchCoursebyrate', 'as'=>'searchCoursebyrate']);
Route::get('/searchcategory/{id}', ['uses' =>'CoursesController@searchcategory', 'as'=>'searchcategory']);
Route::get('/searchsubcategory/{id}', ['uses' =>'CoursesController@searchsubcategory', 'as'=>'searchsubcategory']);

//===========================Footer Quicklinks===============================//
Route::get('/aboutus', ['uses' =>'CoursesController@aboutus', 'as'=>'aboutus']);
Route::get('/contactus', ['uses' =>'CoursesController@contactus', 'as'=>'contactus']);
Route::get('/support', ['uses' =>'CoursesController@support', 'as'=>'support']);

//==========================Footer Importantlinks========================//
Route::get('/privacy', ['uses' =>'CoursesController@privacypolicy', 'as'=>'privacy']);
Route::get('/terms', ['uses' =>'CoursesController@terms', 'as'=>'terms']);
Route::get('/feedback', ['uses' =>'CoursesController@feedback', 'as'=>'feedback']);
Route::get('/disclaimer', ['uses' =>'CoursesController@disclaimer', 'as'=>'disclaimer']);
Route::get('/sitemap', ['uses' =>'CoursesController@sitemap', 'as'=>'sitemap']);
Route::get('/UserFeedbacksave', ['uses' =>'CoursesController@UserFeedbacksave', 'as'=>'UserFeedbacksave']);
...
Route::get('coursedetail/{id}', 'Frontend\CoursedetailController@index')->name('coursedetail');
Route::get('courselist/{id}', 'Frontend\CourselistController@index')->name('courselist');
Route::get('subcat_course/{id}', 'Frontend\CourselistController@subcategory')->name('subcat_course');

Route::get('getdepartment', 'Frontend\CourselistController@getdepartment')->name('getdepartment');
Route::get('getcokie', 'Frontend\HomeController@index')->name('getcokie');

Route::get('getdptname', 'Frontend\HomeController@getdptname')->name('getdptname');
